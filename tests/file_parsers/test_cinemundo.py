...
class TestCinemundo(unittest.TestCase):
    def test_Cinemundo_process_title_01(self) -> None:
        ...
        # Call the function
        actual_result = Cinemundo.process_title('Mortadela e Salamão: Missão Não Possível VP')
    ...
    def test_Cinemundo_process_title_02(self) -> None:
        ...
        # Call the function
        actual_result = Cinemundo.process_title('Je m´appelle Bernadette')
    ...
    def test_Cinemundo_process_title_03(self) -> None:
        ...
        # Call the function
        actual_result = Cinemundo.process_title('True Justice S2: Vengeance is Mine')
